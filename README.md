...
# A simple Android application for discovering movies using the TMDB API.

# 

# The project was built as a take-home assignment with a focus on clean architecture, separation of concerns, testability, and a straightforward user experience.
...
# \* \*\*OkHttp\*\* for HTTP client configuration and authentication
...
# \* \*\*JUnit + MockK + kotlinx-coroutines-test\*\* for unit testing
...
# This separation keeps the business logic independent from the concrete data sources and makes the code easier to test and maintain.
...
# TMDB\_API\_TOKEN=your\_token\_here
